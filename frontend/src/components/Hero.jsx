            ...
            <div className='w-full sm:w-1/2 flex items-center justify-center py-10 sm:py-0'>
                <div className='text-[#414141]'>
                    <div className='flex items-center gap-2'>
                        ...
                        <p className='font-medium text-sm md:text-base'>OUR BESTSERVICE PROVIDERS</p> {/* ✅ Fixed md: text-base */}
                    </div>
                    <h1 className='prata-regular text-3xl sm:py-3 lg:text-5xl leading-relaxed'> {/* ✅ Fixed text-3x1 and text-5x1 */}
                        Latest SERVICES
                    </h1>
                    <div className='flex items-center gap-2'>
                        <p className='font-semibold text-sm md:text-base'>BOOK NOW</p> {/* ✅ Fixed md: text-base */}
